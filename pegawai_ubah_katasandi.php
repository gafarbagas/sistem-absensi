...
<head>
    ...
    ?>
    <title>Ubah Kata Sandi Pegawai</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 text-dark">Ubah Kata Sandi Pegawai</h1>
                    </div>
                    ...
                    <?php 
                        if (isset($_POST['ubah'])) 
                        {
                            ...
                            $query = "UPDATE pengguna SET password='$password' WHERE id_pengguna='$penggunaPegawai[id_pengguna]'";
                            ...
                            if ($ubah) {
                                ...
                                echo "<script>window.location='pegawai_ubah_katasandi.php?id=$_GET[id]'</script>";
                            }
                        }
                    ?>
                </div>
