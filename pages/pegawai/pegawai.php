    ...
    <div class="col-md">
        <div class="card">
            <div class="card-header py-3">
                <a href="index.php?halaman=pegawai-tambah" class="btn btn-primary btn-icon-split btn-sm mb-1">
                    ...
                    <table class="table table-bordered table-hover table-sm text-dark nowrap" width="100%" cellspacing="0" id="projecttable">
                        ...
                        ?>
                            ...
                            <td><?php echo $nomor++ ?>.</td>
                                ...
                                <td>
                                    <a href="index.php?halaman=pegawai-ubah&id=<?php echo $pegawai['id_pegawai'];?>" class="btn btn-sm btn-info shadow-sm mb-1"><i class="fa fa-pencil-alt"></i></a>
                                    <a href="index.php?halaman=pegawai-hapus&id=<?php echo $pegawai['id_pegawai'];?>" class="btn btn-sm btn-danger mb-1 delete-confirm"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                            }
